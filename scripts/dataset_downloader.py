...
def main():
    parser = argparse.ArgumentParser(description="Download PlantVillage Leaf Disease Dataset")
    parser.add_argument("--output-dir", type=str, default="data/raw", help="Directory to save raw dataset")
    parser.add_argument("--source", type=str, choices=["auto", "http", "kaggle"], default="auto", help="Download source method")
    ...
    classes_found = organize_plantvillage_folder(raw_dir)
